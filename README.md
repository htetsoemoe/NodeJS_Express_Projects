...
&nbsp;&nbsp;Fetch data from [openweather](https://openweathermap.org/) using Express routing and log response to console.<br />

<h3>Project Name : weatherapi_final</h3>
&nbsp;&nbsp;Fetch data from [openweather](https://openweathermap.org/) using Express routing and Leaflet.js.<br />
